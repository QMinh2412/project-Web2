<div class="admin-wrapper" id="admin-wrapper-provider-create">
    <div class="admin-header" id="provider-header">
        ...
        <form id="create-provider-form" method="POST" action="?page=provider&action=create">
            ...
            <input class="provider-create-text" type="text" name="provider_name" id="provider-name-input" placeholder="Tên nhà cung cấp" required>
            <label class="provider-create-label" for="provider-address">Địa chỉ nhà cung cấp:</label><br>
            <input class="provider-create-text" type="text" name="provider_address" id="provider-address-input" placeholder="Địa chỉ nhà cung cấp">
            <label class="provider-create-label" for="provider-email">Email nhà cung cấp:</label><br>
            <input class="provider-create-text" type="email" name="provider_email" id="provider-email-input" placeholder="Email nhà cung cấp">
