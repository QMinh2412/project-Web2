    ...
    <div class="admin-header" id="category-header">
        ...
        <form method="POST" action="?page=category&action=create">
            ...
            <div class="category-create-Btn-div">
                <button type="submit" class="category-create-Btns" id="createCategoryBtn">
                    <i class='bx bx-check'></i>
                    Áp dụng thay đổi
                </button>
                <button type="button" class="category-create-Btns" id="cancelCategoryBtn" onclick="location.href='?page=category&action=index'">
                    <i class='bx bx-x'></i>
                    Hủy
                </button>
            </div>
