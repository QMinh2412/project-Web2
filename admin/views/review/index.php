<div class="admin-wrapper">
    ...
    <div>
        <input type="text" id="search-review" placeholder="Tìm kiếm đánh giá...">
    </div>
            ...
            <?php foreach ($reviews as $review): ?>
                <tr class="admin-list-body-content">
                    ...
                    <td class="admin-list-body-content-other" id="review-features">
                        <button class="btn-review btn-view" onclick="location.href='?page=review&action=view&id=<?= $review['MaDG'] ?>'">Xem</button>
                        <button class="btn-review btn-reply" onclick="window.location.href='/project-Web2/user/index.php?page=detail&action=show_detail&id_book=2'">Phản hồi</button>
                    </td>
                </tr>
            <?php endforeach; ?>
        </tbody>
