        ...
        <tbody class="admin-list-body">
            ...
            <?php foreach ($users as $user): ?>
                <tr class="admin-list-body-content">
                    <td class="admin-list-body-content-num" id="user-stt" data-label="STT"><?= $stt++ ?></td>

                    <td class="admin-list-body-content-other" id="user-name" data-label="Họ tên">
                        <?= htmlspecialchars($user['TenND']) ?>
                    </td>

                    <td class="admin-list-body-content-other" id="user-email" data-label="Email">
                        <?= htmlspecialchars($user['EmailND']) ?>
                    </td>

                    <td class="admin-list-body-content-other" id="user-role" data-label="Loại tài khoản">
                        <?= ($user['LoaiTK'] == 1) ? 'Quản lý' : 
                            (($user['LoaiTK'] == 2) ? 'Nhân viên' : 
                            (($user['LoaiTK'] == 3) ? 'Admin' : 'Người dùng')) ?>
                    </td>

                    <td class="admin-list-body-content-other" id="user-status" data-label="Tình trạng">
                        <label class="switch">
                    ...
                    <td class="admin-list-body-content-other" id="user-action" data-label="Chức năng">
